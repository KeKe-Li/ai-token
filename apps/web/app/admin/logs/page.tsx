...
type LogEntry = { id: number; user_id: number; model: string; status_code: number; input_tokens: number; output_tokens: number; cost: number; latency_ms: number; ip_address: string; created_at: string };
